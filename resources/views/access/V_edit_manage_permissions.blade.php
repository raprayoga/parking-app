      ...
      <div class="container">
        <form action="{{ url('permissions/'.$data->id) }}" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="permissions" aria-describedby="permissionsHelp" placeholder="Enter Permission" name="permissions" value="{{ $data->name }}" required>
