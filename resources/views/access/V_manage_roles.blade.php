    ...
    <div class="card-header">
      ...
      <div class="row">
        <div class="col-12 text-right">
          <a href="{{ url('/roles/create') }}" class="btn btn-info"><i class="fas fa-plus-circle"></i> Add Roles</a>
        </div>
      </div>
    </div>
    <!-- /.card-header -->
        ...
        <tbody>
          ...
          <tr class="text-center">
            ...
            <td class="text-center">
              <form action="{{ url('/roles/'.$data->id) }}" onsubmit="return confirm('Do you really want to delete it?');" method="POST">
                @method('DELETE')
                @csrf
                <a href="{{ url('/roles/'.$data->id.'/edit') }}" class="btn btn-sm btn-warning" title="Edit"><i class="fas fa-edit" style="color: white;"></i></a>
